...
Timelimit = (function () {
  ...
  Timelimit.prototype.check = function () {
    ...
    return returning((elapsed = Date.now() - this.started), function () {
...
ThreeBSP.prototype.toMesh = function (material) {
  ...
  return this.options.timer.doTask(function () {
...
ThreeBSP.Vertex = (function (_super) {
  ...
  Vertex.prototype.lerp = function (v, alpha) {
    var _this = this;
    return returning((<any>Vertex).__super__.lerp.apply(this, arguments), function () {
...
ThreeBSP.Node = (function () {
  ...
  Node.prototype.clone = function () {
    var node,
      _this = this;
    return returning((node = new ThreeBSP.Node(this.options)), function () {
      var _ref;
  ...
  function Node(polygons, options?:any) {
    ...
    this.polygons = [];
    this.options.timer.doTask(function () {
  ...
  Node.prototype.build = function (polygons) {
    var _this = this;
    return returning(this, function () {
      var polys, side, sides, _ref, _ref1, _results;
      sides = {
        front: [],
        back: []
      };
